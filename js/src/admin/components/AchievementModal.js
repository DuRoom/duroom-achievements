...
import Modal from "duroom/components/Modal";
import Button from "duroom/components/Button";
import Checkbox from "duroom/components/Checkbox";
import Tooltip from "duroom/components/Tooltip";
import LoadingIndicator from "duroom/components/LoadingIndicator";
import ItemList from "duroom/utils/ItemList";
import Stream from "duroom/utils/Stream";
...
export default class AchievementModal extends Modal {
  ...
  title() {
    return this.name()
      ...
      : app.translator.trans(
        "duroom-achievements.admin.achievement_modal.title"
      );
  }
  ...
  fields() {
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "duroom-achievements.admin.achievement_modal.name_label"
          )}
        </label>
        <input
          className="FormControl"
          placeholder={app.translator.trans(
            "duroom-achievements.admin.achievement_modal.name_placeholder"
          )}
          bidi={this.name}
        />
      </div>,
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "duroom-achievements.admin.achievement_modal.active_label"
          )}
        </label>
        {Checkbox.component(
          {
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "duroom-achievements.admin.achievement_modal.hidden_label"
          )}
        </label>
        {Checkbox.component(
          {
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "duroom-achievements.admin.achievement_modal.description_label"
          )}
        </label>
        <input
          className="FormControl"
          placeholder={app.translator.trans(
            "duroom-achievements.admin.achievement_modal.description_placeholder"
          )}
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>{app.translator.trans(
          "duroom-achievements.admin.achievement_modal.variable_label"
        )}</label>
        <GroupSelector
          label={app.translator.trans(
            "duroom-achievements.admin.achievement_modal.variable_label"
        ...
        <Tooltip id='Tooltip-computation' text="">
          <input
            ...
            placeholder={app.translator.trans(
              "duroom-achievements.admin.achievement_modal.computation_placeholder"
            )}
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "duroom-achievements.admin.achievement_modal.points_label"
          )}
        </label>
        <input
          className="FormControl"
          placeholder={app.translator.trans(
            "duroom-achievements.admin.achievement_modal.points_placeholder"
          )}
          bidi={this.points}
        />
      </div>,
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>
          {app.translator.trans(
            "duroom-achievements.admin.achievement_modal.image_label"
          )}
        </label>
        <input
          className="FormControl"
          placeholder={app.translator.trans(
            "duroom-achievements.admin.achievement_modal.image_placeholder"
          )}
          bidi={this.image}
        ...
        <table className="AchievementModal-Table">
          <tr>
            <td>
              <label>
                {app.translator.trans(
                  "duroom-achievements.admin.achievement_modal.height_label"
                )}
              </label>
            </td>
            <td>
              <label>
                {app.translator.trans(
                  "duroom-achievements.admin.achievement_modal.width_label"
                )}
              </label>
            </td>
          </tr>
        ...
        <table className="AchievementModal-Table">
          <tr>
            <td>
              <label>
                {app.translator.trans(
                  "duroom-achievements.admin.achievement_modal.row_label"
                )}
              </label>
            </td>
            <td>
              <label>
                {app.translator.trans(
                  "duroom-achievements.admin.achievement_modal.col_label"
                )}
              </label>
            </td>
          </tr>
    ...
    items.add(
      ...
      <div className="Form-group">
        {Button.component(
          ...
          app.translator.trans(
            "duroom-achievements.admin.achievement_modal.submit_button"
          )
        )}
        {this.achievement.exists ? (
          ...
          >
            {app.translator.trans(
              "duroom-achievements.admin.achievement_modal.delete_button"
            )}
          </button>
        ) : (
          ""
  ...
  delete() {
    if (
      confirm(
        app.translator.trans(
          "duroom-achievements.admin.achievement_modal.delete_confirmation"
        )
      )
    ) {
