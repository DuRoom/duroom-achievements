  ...
  title() {
    return this.name()
      ...
      : app.translator.trans(
          "duroom-achievements.admin.achievement_modal.add_delete_title"
        );
  }
  ...
  fields() {
    ...
    items.add(
      ...
      <div className="Form-group">
          <p>{app.translator.trans(
                "duroom-achievements.admin.achievement_modal.add_delete_instructions"
            )}</p>
      </div>,
      50
      );
    items.add(
        ...
        <div className="Form-group">
            <label>
            {app.translator.trans(
                "duroom-achievements.admin.achievement_modal.username"
            )}
            </label>
            <input
            className="FormControl"
            placeholder={app.translator.trans(
                "duroom-achievements.admin.achievement_modal.username_placeholder"
            )}
            bidi={this.user_id}
            />
        </div>,
